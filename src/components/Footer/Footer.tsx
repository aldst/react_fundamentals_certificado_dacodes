...
const FooterComponent = () => {
  ...
  return (
    <div className="fondo">
      ...
      <Title className="texto_blanco interlineado" level={5} style={{ lineHeight: 1.3, fontSize: 12, fontWeight: 'lighter', marginRight: 250 }}>
      ...
      <Row justify={'start'} align="middle" gutter={[16, 24]} style={{paddingTop: 20, paddingBottom: 5 }}>
        <Col span={2}>
