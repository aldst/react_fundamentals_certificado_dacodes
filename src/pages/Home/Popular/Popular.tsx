...
const PopularComponent = () => {
  ...
  return (
    <Template>
      ...
      <SegmentedComponent selectedSegmented="popular"></SegmentedComponent>

      <Title className="texto_blanco" level={2} style={{ marginTop: 40, marginLeft: 5, marginBottom: 40 }}>Popular</Title>
