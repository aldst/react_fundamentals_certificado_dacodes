...
const UpcomingComponent = () => {
  ...
  const fetchAndSetMovies = async () => {
    const result = await getMovies('upcoming', currentPage);
    setMovies(result)
  };
  ...
  return (
    <Template>
      ...
      <SegmentedComponent selectedSegmented="upcoming"></SegmentedComponent>

      <Title className="texto_blanco" level={2} style={{ marginTop: 40, marginLeft: 5, marginBottom: 40 }}>Upcoming</Title>
